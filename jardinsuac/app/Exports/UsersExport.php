    ...
    */
    public function collection()
    {
        $table_content = DB::table('taxas')->select(['NumControlo', 'Group', 'Division', 'Family','ScientificName',
            ...
            'Status_at_Azores_Link',  'Grupo',  'Nome_comum',  'Nome_comum_Referencia',
             'Nome_comum_Link',
             'Regiao_geografica_de_origem',  'Estado_de_conservacao',
             'Estatuto_na_Regiao_Açores',  'Breve_descricao',
        ...
        $array = ['A1' => 'NumControlo', 'A2'=> 'Group', 'A3' => 'Division', 'A4' => 'Family', 'A5' => 'ScientificName',
            ...
            'A21'=> 'Status_at_Azores_Link', 'A22'=> 'Grupo', 'A23'=> 'Nome_comum', 'A24'=> 'Nome_comum_Referencia',
            'A25'=> 'Nome_comum_Link',
            'A26'=> 'Regiao_geografica_de_origem', 'A27'=> 'Estado_de_conservacao',
            'A28'=> 'Estatuto_na_Regiao_Acores', 'A29'=> 'Breve_descricao',
